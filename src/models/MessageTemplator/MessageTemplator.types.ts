...
export interface MessageTemplatorActions {
  addCondition(textNodeId: string, textBefore: string, textAfter: string): readonly [textNodeBefore: TextNode, conditionNode: ConditionNode, textNodeAfter: TextNode] | undefined;
